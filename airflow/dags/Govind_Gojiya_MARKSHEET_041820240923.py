...
@dag(
    dag_id="Govind_Gojiya_MARKSHEET_041820240923",
    schedule="0 0 * * 6",
    catchup=False,
    ...
    def extract(ti, **kwargs):
        try:
            ...
            with engine_object.engine.connect() as connection:
                connection.execute(update_dag_run_query, dag_run_id=dag_run_id, table_id=37)
            ...
            ti.xcom_push(key='table_name', value='MARKSHEET')
            ti.xcom_push(key='table_id', value=37)
