...
@dag(
    dag_id="Govind_Gojiya_customer_data_041720241337",
    schedule="0 */10 * * *",
    catchup=False,
    ...
    def extract(ti, **kwargs):
        ...
        try:
            ...
            with engine_object.engine.connect() as connection:
                connection.execute(update_dag_run_query, dag_run_id=dag_run_id, table_id=30)
            ...
            ti.xcom_push(key='table_name', value='customer_data')
            ti.xcom_push(key='table_id', value=30)
