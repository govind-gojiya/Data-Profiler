...
@dag(
    dag_id="Govind_Gojiya_demo_041820240513",
    schedule="0 0 * * 4",
    catchup=False,
    ...
    def extract(ti, **kwargs):
        ...
        try:
            ...
            with engine_object.engine.connect() as connection:
                connection.execute(update_dag_run_query, dag_run_id=dag_run_id, table_id=34)
            ...
            ti.xcom_push(key='table_name', value='demo')
            ti.xcom_push(key='table_id', value=34)
