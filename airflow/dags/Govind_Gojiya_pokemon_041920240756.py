...
@dag(
    dag_id="Govind_Gojiya_pokemon_041920240756",
    schedule="0 0 * * 3",
    catchup=False,
    ...
    def extract(ti, **kwargs):
        ...
        try:
            ...
            with engine_object.engine.connect() as connection:
                connection.execute(update_dag_run_query, dag_run_id=dag_run_id, table_id=40)
            
            hostname = 'dpg-cnugjtol6cac73aisfug-a.oregon-postgres.render.com'
            portnumber = 5432
            username = 'dome_db_k5yq_user'
            password = 'BcFIgquCnbIdRiierzuslWy1bdYMWmUR'
            database_name = 'dome_db_k5yq'
            ...
            ti.xcom_push(key='table_name', value='pokemon')
            ti.xcom_push(key='table_id', value=40)
