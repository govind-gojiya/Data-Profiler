...
@dag(
    dag_id="Govind_Gojiya_stock_prices_041720241337",
    schedule="0 */23 * * *",
    catchup=False,
    ...
    def extract(ti, **kwargs):
        ...
        try:
            ...
            with engine_object.engine.connect() as connection:
                connection.execute(update_dag_run_query, dag_run_id=dag_run_id, table_id=31)
            ...
            ti.xcom_push(key='table_name', value='stock_prices')
            ti.xcom_push(key='table_id', value=31)
