...
@dag(
    dag_id="Govind_Gojiya_student_grades_041720241337",
    schedule="0 0 * * 2",
    catchup=False,
    ...
    def extract(ti, **kwargs):
        ...
        try:
            ...
            with engine_object.engine.connect() as connection:
                connection.execute(update_dag_run_query, dag_run_id=dag_run_id, table_id=27)
            ...
            ti.xcom_push(key='table_name', value='student_grades')
            ti.xcom_push(key='table_id', value=27)
