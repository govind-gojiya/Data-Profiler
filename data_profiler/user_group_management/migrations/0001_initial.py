# Generated by Django 5.0.2 on 2024-03-31 14:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_type', models.SmallIntegerField(choices=[(1, 'Organization'), (2, 'Group')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='members', to='user_group_management.group')),
